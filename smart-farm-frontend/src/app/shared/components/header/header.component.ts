...
export class HeaderComponent implements OnDestroy {
  ...
  notifications = this.notificationService.notifications.bind(this.notificationService);
  unread = this.notificationService.unreadCount.bind(this.notificationService);
